...
sed -i 'set network.$1.gateway='192.168.10.1'' openwrt/package/base-files/files/bin/config_generate
sed -i 'set network.$1.dns='1.2.4.8'' openwrt/package/base-files/files/bin/config_generate
